...
/*-----------------------------------------------
              @(target):= _cppmpc_swig.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__cppmpc_swig

#else
#  define SWIG_init    init_cppmpc_swig

#endif
#define SWIG_name    "_cppmpc_swig"
...
SWIGINTERN PyObject *_wrap_new_SymbolicObjective(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  cppmpc::SymbolicObjective *result = 0 ;
  
  if (!SWIG_Python_UnpackTuple(args, "new_SymbolicObjective", 0, 0, 0)) SWIG_fail;
  result = (cppmpc::SymbolicObjective *)new cppmpc::SymbolicObjective();
  resultobj = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_cppmpc__SymbolicObjective, SWIG_POINTER_NEW |  0 );
  return resultobj;
fail:
  return NULL;
}
...
SWIGINTERN PyObject *_wrap_delete_SymbolicObjective(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  cppmpc::SymbolicObjective *arg1 = (cppmpc::SymbolicObjective *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  PyObject *swig_obj[1] ;
  ...
  if (!args) SWIG_fail;
  swig_obj[0] = args;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_cppmpc__SymbolicObjective, SWIG_POINTER_DISOWN |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "delete_SymbolicObjective" "', argument " "1"" of type '" "cppmpc::SymbolicObjective *""'"); 
  }
  arg1 = reinterpret_cast< cppmpc::SymbolicObjective * >(argp1);
  delete arg1;
  resultobj = SWIG_Py_Void();
  return resultobj;
fail:
...
SWIGINTERN PyObject *SymbolicObjective_swigregister(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *obj;
  if (!SWIG_Python_UnpackTuple(args, "swigregister", 1, 1, &obj)) return NULL;
  SWIG_TypeNewClientData(SWIGTYPE_p_cppmpc__SymbolicObjective, SWIG_NewClientData(obj));
  return SWIG_Py_Void();
}

SWIGINTERN PyObject *SymbolicObjective_swiginit(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  return SWIG_Python_InitShadowInstance(args);
}

SWIGINTERN PyObject *_wrap_echo(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  RCP< Basic const > *arg1 = 0 ;
  PyObject *swig_obj[1] ;
  RCP< Basic const > *result = 0 ;
  ...
  result = (RCP< Basic const > *) &cppmpc::Utility::echo((RCP< Basic const > const &)*arg1);
  {
    // Check how this impacts memory management, same as above.
    CRCPBasic* rcp_basic;
    rcp_basic = (CRCPBasic*)result;
    PyObject* capsule = PyCapsule_New(rcp_basic, NULL, NULL);
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { "new_SymbolicObjective", _wrap_new_SymbolicObjective, METH_NOARGS, NULL},
	 { "delete_SymbolicObjective", _wrap_delete_SymbolicObjective, METH_O, NULL},
